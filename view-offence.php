                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
							 ...
							 <label for="filter">Search</label> <input type="text" name="filter" value="" id="myInput" placeholder="Search with Name" onkeyup="myFunction()"/>
...
?>
	...
	<?php } ?>
                                ...
                                <a href="generate-report.php" class="btn btn-success">Generate Report</a>
